<template>
  <div>
    ...
    <div v-for="matter in entrustedMatters" v-bind:key="matter.id">
      <table class="table01">
        <tr>
  ...
  async created() {
    ...
    db.collection("matters")
      ...
      .onSnapshot((querySnapshot) => {
        ...
        this.entrustedMatters = matters.filter(
          (value) => value.entrustedCompanyId == account.uid
        ); //ログインしてる会社のIDを元に受託中の案件を抽出
      });
  },
